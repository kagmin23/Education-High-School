...
const StudentTimetable = () => {
  ...
  useEffect(() => {
    ...
    const storedTimetables = localStorage.getItem('studentTimetablesData');
    if (storedTimetables) {
      try {
        ...
        if (!parsedTimetables[DEFAULT_CLASS]) {
          ...
          localStorage.setItem('studentTimetablesData', JSON.stringify(updatedTimetables));
        }
      } catch (error) {
      ...
      localStorage.setItem('studentTimetablesData', JSON.stringify(initialTimetables));
    }
  }, []);
  ...
  const handleSaveAll = () => {
    ...
    localStorage.setItem('studentTimetablesData', JSON.stringify(tempTimetableData));
  ...
  const handleSaveSubject = () => {
    ...
    localStorage.setItem('studentTimetablesData', JSON.stringify(updatedTimetableData));
