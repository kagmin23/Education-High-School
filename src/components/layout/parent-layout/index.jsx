import { HomeOutlined, InsertRowAboveOutlined, LogoutOutlined, ProfileOutlined, SettingOutlined, SignatureOutlined, SnippetsOutlined } from '@ant-design/icons';
  ...
  const menu = (
    <Menu>
      <Menu.Item key="profile" icon={<ProfileOutlined />}>
        <Link to="/parent/profile">Hồ sơ Học sinh</Link>
      </Menu.Item>
